...
class AdvancedKLinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double maxH = data.map((e) => e['high'] as double).reduce(math.max);
    double minL = data.map((e) => e['low'] as double).reduce(math.min);
    double maxV = data.map((e) => e['volume'] as double).reduce(math.max);
